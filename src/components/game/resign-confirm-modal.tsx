                ...
                <GlassBg className="p-8 text-center" height={280}>
                    <div className="flex flex-col items-center gap-6">
                        <div className="relative">
                            <div className="h-20 w-20 rounded-full bg-linear-to-br from-red-500/20 to-orange-500/20 flex items-center justify-center border border-white/10 shadow-xl shadow-red-500/10">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-xl font-bold text-white">Resign Game?</h2>
