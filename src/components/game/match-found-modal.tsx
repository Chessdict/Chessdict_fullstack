    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="w-full max-w-sm animate-in zoom-in-95 duration-300">
                <GlassBg className="p-8 text-center" height={320}>
                    <div className="flex flex-col items-center gap-6">
                        <div className="relative">
                            <div className="h-24 w-24 rounded-full bg-linear-to-br from-green-500/20 to-blue-500/20 flex items-center justify-center border border-white/10 shadow-xl shadow-green-500/10">
                                <span className="text-3xl font-bold text-white uppercase">{opponent.slice(2, 4)}</span>
                            </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-xs font-medium text-blue-400 uppercase tracking-widest mt-2">
                        ...
                        <button
                            onClick={onAccept}
                            className="w-full relative group overflow-hidden rounded-full py-4 transition-transform active:scale-95 mt-2"
                        >
